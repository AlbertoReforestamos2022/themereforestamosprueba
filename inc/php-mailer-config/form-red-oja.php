...
function formulario_red_oja() {
    // Verificar nonce
    if (!isset($_POST['form_red_oja']) || !wp_verify_nonce($_POST['form_red_oja'], 'submit_contact_form')) {
    ...
    $title = "Red Oja formulario de contacto";
...
add_action('wp_ajax_formulario_red_oja', 'formulario_red_oja');
add_action('wp_ajax_nopriv_formulario_red_oja', 'formulario_red_oja');
