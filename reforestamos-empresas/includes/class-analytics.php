...
/**
 * Reforestamos_Analytics class
 *
 * Tracks clicks on company logos and links, provides dashboard
 * metrics, and supports CSV export of analytics data.
 *
 * @package Reforestamos_Empresas
 * @since 1.0.0
 */
class Reforestamos_Analytics {
	...
	public static function render_dashboard() {
		...
		$clicks_by_company = $wpdb->get_results(
			$wpdb->prepare(
