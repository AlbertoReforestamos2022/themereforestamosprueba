			...
			<InspectorControls>
				<PanelBody title={__('Timeline Settings', 'reforestamos')}>
					<SelectControl
						...
						options={[
							{
								label: __('Vertical', 'reforestamos'),
								value: 'vertical',
							},
							{
								label: __('Horizontal', 'reforestamos'),
								value: 'horizontal',
							},
						]}
						onChange={(value) =>
					...
					{events.length === 0 ? (
						...
						<div className="timeline-events">
							{events.map((event, index) => (
								<div
									key={index}
									className={`timeline-event timeline-event-${index % 2 === 0 ? 'left' : 'right'}`}
								>
									<div className="timeline-event-content">
										...
										<TextControl
											...
											placeholder={__(
												'e.g., dashicons-calendar',
												'reforestamos'
											)}
											help={__(
												'Enter a Dashicons class name',
												'reforestamos'
											)}
										/>
