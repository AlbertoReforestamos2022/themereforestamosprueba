...
export default function Edit({ attributes, setAttributes }) {
			...
			<div key={evento.id} className="evento-card">
				...
				<div className="evento-content">
					...
					<div
						...
						dangerouslySetInnerHTML={{
							__html: evento.excerpt.rendered,
						}}
					/>
	...
	return (
		<>
			<InspectorControls>
				<PanelBody
					title={__('Configuración de Eventos', 'reforestamos')}
				>
					<RangeControl
					...
					<ToggleControl
						...
						help={__(
							'Si está activado, se mostrarán también eventos que ya pasaron',
							'reforestamos'
						)}
					/>
					<SelectControl
						...
						options={[
							{
								label: __('Tarjetas', 'reforestamos'),
								value: 'cards',
							},
							{
								label: __('Lista', 'reforestamos'),
								value: 'list',
							},
							{
			...
			<div {...blockProps}>
				...
				{eventos.length === 0 ? (
					<div className="eventos-empty">
						<p>
							{__(
								'No hay eventos disponibles. Los eventos se cargarán cuando el CPT "Eventos" esté configurado.',
								'reforestamos'
							)}
						</p>
						<p className="text-muted">
							{__(
								'Este bloque está listo para consumir la REST API de eventos.',
								'reforestamos'
							)}
						</p>
					</div>
