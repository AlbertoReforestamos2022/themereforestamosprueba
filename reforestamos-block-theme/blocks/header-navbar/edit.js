...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody title={__('Header Settings', 'reforestamos')}>
					<SelectControl
						...
						help={__(
							'Choose which WordPress menu to display',
							'reforestamos'
						)}
					/>
				...
				<PanelBody
					title={__('Appearance', 'reforestamos')}
					initialOpen={false}
				>
					<SelectControl
					...
					<ToggleControl
						...
						onChange={(value) =>
							setAttributes({ transparentOnTop: value })
						}
						help={__(
							'Header becomes transparent when at page top, solid when scrolling',
							'reforestamos'
						)}
					/>
				</PanelBody>
				...
				<PanelBody
					title={__('Features', 'reforestamos')}
					initialOpen={false}
				>
					<ToggleControl
						...
						onChange={(value) =>
							setAttributes({ showLanguageSwitcher: value })
						}
						help={__(
							'Display language switcher (ES/EN)',
							'reforestamos'
						)}
					/>
				</PanelBody>
			...
			<div {...blockProps}>
				<div
					className={`header-navbar-preview bg-${backgroundColor} text-${textColor}`}
				>
					...
					<div className="preview-info">
						...
						{transparentOnTop && (
							<span className="badge">Transparent on Top</span>
						)}
						{menuId && (
