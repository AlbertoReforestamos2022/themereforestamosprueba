...
import { PanelBody, SelectControl, RangeControl, Button, Placeholder } from '@wordpress/components';
            ...
            <InspectorControls>
                <PanelBody title={__('Layout Settings', 'reforestamos')}>
                    <SelectControl
                        ...
                        value={imagePosition}
                        options={[
                            { label: __('Left', 'reforestamos'), value: 'left' },
                            { label: __('Right', 'reforestamos'), value: 'right' }
                        ]}
                        onChange={(value) => setAttributes({ imagePosition: value })}
                        help={__('Choose where to display the image', 'reforestamos')}
                    />
                    <RangeControl
                        ...
                        max={70}
                        step={5}
                        help={__('Adjust the width of the image column', 'reforestamos')}
                    />
                </PanelBody>
            </InspectorControls>
                ...
                <div className="texto-imagen-container">
                    ...
                    >
                        <RichText
                            ...
                            placeholder={__('Enter your text content here...', 'reforestamos')}
                        ...
                        {!image.url ? (
                            <MediaUploadCheck>
                                <Placeholder
                                    ...
                                    instructions={__('Select an image to display', 'reforestamos')}
                                >
                                    <MediaUpload
