    ...
    return (
        <div {...blockProps}>
            <div className="galeria-tabs-container">
                {/* Tabs Navigation */}
                <ul className="nav nav-tabs" id={`${galleryId}-tabs`} role="tablist">
                            ...
                            {gallery.images && gallery.images.length > 0 ? (
                                <div className="row g-3 gallery-grid">
                                    {gallery.images.map((image, imageIndex) => (
                                        <div key={imageIndex} className="col-6 col-md-4 col-lg-3">
                                            <a
                                                href={image.url}
                                ...
                                <p className="no-images-message">No hay imágenes en esta categoría.</p>
                            )}
                        </div>
                    ))}
                </div>
