...
export default function Save({ attributes }) {
	...
	return (
		<div {...blockProps}>
			<div
				className={`reforestamos-cards-iniciativas__container container`}
			>
				<div
					className={`reforestamos-cards-iniciativas__grid reforestamos-cards-iniciativas__grid--${layout}`}
				>
