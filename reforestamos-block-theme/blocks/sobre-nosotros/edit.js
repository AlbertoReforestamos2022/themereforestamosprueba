...
export default function Edit({ attributes, setAttributes }) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody
					title={__('Configuración de Sección', 'reforestamos')}
				>
					<ToggleControl
				...
				{showStats && (
					<PanelBody
						title={__('Estadísticas', 'reforestamos')}
						initialOpen={false}
					>
				...
				{showTeam && (
					<PanelBody
						title={__('Miembros del Equipo', 'reforestamos')}
						initialOpen={false}
					>
						{team.map((member, index) => (
							...
							>
								...
								<hr />
								<strong>
									{__('Redes Sociales', 'reforestamos')}
								</strong>
								<TextControl
									label="Facebook"
