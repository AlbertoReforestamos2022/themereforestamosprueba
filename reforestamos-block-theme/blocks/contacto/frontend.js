...
(function() {
    ...
    function handleFormSubmit(event) {
        ...
        setTimeout(() => {
            ...
            console.log('Note: Actual email sending will be implemented in Communication Plugin (Task 20)');
        }, 1000);
    ...
    function showMessage(form, type) {
        const messagesContainer = form.querySelector('.reforestamos-contacto__form-messages');
