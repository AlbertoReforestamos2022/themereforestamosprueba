...
(function($) {
    ...
    $(document).ready(function() {
        ...
        $form.on('submit', function(e) {
            ...
            $submitBtn.prop('disabled', true).text(reforestamosCom.strings.sending || 'Enviando...');
            ...
            $.ajax({
                ...
                error: function() {
                    $messages.html('<div class="alert alert-danger">' + (reforestamosCom.strings.error || 'Error al procesar la solicitud') + '</div>');
                },
                complete: function() {
        ...
        $quantity.on('input', function() {
            ...
            $(this).siblings('.form-text').text('Precio por árbol: $' + pricePerTree + ' MXN | Total: $' + total + ' MXN');
        });
    });
