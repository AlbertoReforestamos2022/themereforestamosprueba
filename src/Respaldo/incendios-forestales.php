<?php  /**  printf('<pre>%s</pre>', var_export( get_post_custom( get_the_ID() ), true )); */  ?>
    ...
    <?php /* <!-- Video Incendios forestales -->*/ ?>
    <div class="background-incendios p-3 se-in-fo" style="background-color:rgba(236, 67, 44, 1)!important;">
    ...
    <?php /* <!-- Infográfia Incendios --> */ ?>
    <div class="container pri-inf">
        <?php $titulo_infografia_1 = get_post_meta( get_the_ID(), 'titulo_infografia_1', true ); ?>

        <h4 class="text-danger fw-semibold text-center my-5"> <?php echo $titulo_infografia_1; ?> </h4>
                    ...
                    <div class="contenido <?php echo $infografia['posicion_campo_infografia']; ?>"> 
                        <div class="card border-0 shadow-lg rounded-2">
							...
							<div class="row g-0 justify-content-center">
								<div class="col-6 col-md-4 img-incendios">
									<img class="img-fluid p-2 p-md-1" src="<?php echo $infografia['imagen_infografia']; ?>" width="150" alt="<?php echo $infografia['alt_text']; ?>">
								</div>
								<div class="col-md-8 d-grid align-items-center">
									<div class="card-body texto-incedios text-center text-danger">
										<h5 class="h6 mx-2"><?php echo $infografia['desc_infografia']; ?></h5>
									</div>
								</div>
							</div>
    ...
    <?php /* <!-- Segunda Infográfia incendios forestales --> */ ?>
    <div class="container-xxl seg-inf">
        <?php $titulo_infografia_2 = get_post_meta( get_the_ID(), 'titulo_infografia_2', true ); ?>       
        <h3 class="text-danger fw-semibold my-5 text-center"><?php echo $titulo_infografia_2?></h3>
            ...
            <div class="col mt-5">
                <div class="card border-0">
                    ...
                    <?php $texto_footer_infografia = get_post_meta( get_the_ID(), 'text_footer', true ); ?>
                        <h5 class="card-title text-black-50 text-center"><?php echo $texto_footer_infografia; ?></h5>
                    </div>
                </div>
            </div>
        </div>
    ...
    <?php /* Acciones Reforestamos Mexico */ ?>
    <section class="p-1 p-md-5 ac-re" style="background-color:rgba(245, 209, 56, .82)!important;">
                ...
                <div class="col">
                    <div class="card shadow-lg border-0 py-4">
                        <div class="card-header border-0 bg-transparent text-center">
                            ...
                            <h1 class="h3 text-primary"><?php echo $titulo_acciones; ?></h1>
                        </div>
                        <div class="card-body">    
    ...
    <div class="container qu-nec">
         <div class="card-header border-0 bg-transparent text-center">
            <?php $titulo_brigadistas = !empty(get_post_meta( get_the_ID(), 'titulo_brigadistas', true))  ? get_post_meta( get_the_ID(), 'titulo_brigadistas', true) : ''; ?>     

            <h3 class="text-danger mt-5"><?php echo $titulo_brigadistas; ?></h3>
        </div>

        <div class="row row-cols-auto shadow">
            <?php $brigadistas = get_post_meta( get_the_ID(), 'reforestamos_group_incendios_brigadistas', true ); ?>

            <?php foreach($brigadistas as $brigadista) { ?>
                <div class="col ">
                    <div class="card border-0 bg-transparent p-3">
                        <?php
                            $titulo = $brigadista['titulo_brigradistas'];
                            if(!empty($titulo)) { ?>
                                <div class="card-header border-0 bg-transparent">

                                    <h5 class="bold"><?php echo $titulo;?></h5>
                                </div>
                            <?php
                            }
                        ?>
                        <?php
                            $texto = $brigadista['texto_brigradistas'];

                            if(!empty($texto)) { ?>
                                <div class="card-header border-0 bg-transparent text-black-50">
                                    <?php echo $texto;?>
                                </div>
                            <?php
                            }
        ...
        <div class="card-header border-0 bg-transparent text-center">            
            ...
            <h3 class="text-primary mt-5"><?php echo $titulo_necesidades; ?></h3>
        </div>
                    ...
                    <?php foreach($necesidades as $necesidad) { ?>
                        <div class="col">
                            <div class="card border-0 shadow-lg h-100">
                                <div class="card-header bg-transparent border-0 d-grid justify-content-center align-items-center mb-3">
                                    <img class="img-fluid" src="<?php echo $necesidad['imagen_card']; ?>" width="300" alt="<?php echo $necesidad['titulo_card']; ?> imagen">
                                    <h5 class="text-light text-center mt-4"><?php echo $necesidad['titulo_card']; ?></h5>
                                </div>
    ...
    <?php /* Incendios a nivel nacional*/ ?>
    <?php $background_incendios = get_post_meta( get_the_ID(), 'background_incendios', true ); ?>
    <section class="mapa-incendios se-in-na p-0 m-0" style="background-image: linear-gradient(rgba(0, 0, 0, 0.1), rgba(0, 0, 0, 0.2)), url(<?php echo $background_incendios; ?>);">
        <div class="" style="background-color:rgba(236, 67, 44,1)!important;">
            <div class="container">
                <div class="row">
                    <div class="col">
        ...
        <div class="container">
            <div class="row row-cols-1 row-cols-md-2 justify-content-center my-5">
                <div class="col">
    ...
    <main class="donar-section se-do" style="background-color: #FAFBFE;padding-top:50px; padding-bottom:50px!important;">
        <div class="container">
            ...
            <h2 class="text-center fw-bold text-danger my-4"> <?php echo $titulo_donar; ?> </h2>
                ...
                <div class="col-lg-4">
                    <div class="info-horizontal bg-white shadow p-5" style="height:500px;">
                        ...
                        <div class="description">
                            <h5 class="text-danger text-center fw-bold">Por medio de una donación a nuestra cuenta PayPal:</h5>
                ...
                <div class="col-lg-4 px-lg-1 mt-lg-0 mt-4">
                    <div class="info-horizontal shadow rounded-1 p-5 px-4" style="height: 500px;background-color:rgba(236, 67, 44,.82)!important;">
                        ...
                        <div class="description">
                            ...
                            <h5 class="text-center text-white fw-bold"><?php echo $titulo_datos_bancarios; ?></h5>
    ...
    <section class="container se-al"> 
        <?php $titulo_aliados = !empty(get_post_meta( get_the_ID(), 'titulo_aliados', true )) ? get_post_meta( get_the_ID(), 'titulo_aliados', true ) : '';?>
        <h3 class="text-danger fw-semibold my-5 text-center"><?php echo $titulo_aliados; ?></h3>
                                    ...
                                    <div class="col-lg-8 ms-lg-5">
                                        <div class="info-horizontal">
                                            <div class="description">
                                                ...
                                                <div class="text-white text-cierre">
                                                    <!-- <p>Tu ayuda hace la diferencia, juntos podemos acabar con este incendio forestal y restaurar los suelos que han sufrido grandes daños.</p> -->
                                                    <?php echo $texto_cierre; ?>    
                                                </div>
                                            </div>
