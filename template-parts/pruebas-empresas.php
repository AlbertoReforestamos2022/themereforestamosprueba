    ...
    <section class="container ">
        ...
        <button type="button" class="btn border-light bg-transparent" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
            <img src="http://localhost:8080/wordpress/wp-content/uploads/2023/03/American-express.png" class="img-fluid" width="120" alt="">
        </button>
        ...
        <div class="modal fade" id="staticBackdrop"  data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog">
                ...
                <div class="modal-header d-flex justify-content-center">
                    <h3 class="modal-title text-light fw-semibold" id="staticBackdropLabel">American Express</h3>
                </div>
        ...
        <div class="carrusel">
            <div class="carrusel-inner">
                <div class="carrusel-item ">
                    <img src="http://localhost:8080/wordpress/wp-content/uploads/2023/03/HEB-Logo.png" class="img-fluid d-block w-50" alt="Imagen 1">
                    <caption>img-1</caption>
                </div>
                <div class="carrusel-item">
                    <img src="http://localhost:8080/wordpress/wp-content/uploads/2023/03/mi-tienda-logo.png" class="img-fluid d-block w-50" alt="Imagen 2">
                    <caption>img-2</caption>
                </div>
                <div class="carrusel-item">
                    <img src="http://localhost:8080/wordpress/wp-content/uploads/2023/03/American-express.png" class="img-fluid d-block w-50" alt="Imagen 3">
                    <caption>img-3</caption>
                </div>
                <div class="carrusel-item">
                    <img src="http://localhost:8080/wordpress/wp-content/uploads/2023/03/mi-tienda-logo.png" class="img-fluid d-block w-50" alt="Imagen 4">
                    <caption>img-4</caption>
                </div>
                ...
                <div class="carrusel-item ">
                    <img src="http://localhost:8080/wordpress/wp-content/uploads/2023/03/HEB-Logo.png" class="img-fluid d-block w-50" alt="Imagen 1">
                    <caption>img-5</caption>
                </div>
                <div class="carrusel-item">
                    <img src="http://localhost:8080/wordpress/wp-content/uploads/2023/03/mi-tienda-logo.png" class="img-fluid d-block w-50" alt="Imagen 2">
                    <caption>img-6</caption>
                </div>
                <div class="carrusel-item">
                    <img src="http://localhost:8080/wordpress/wp-content/uploads/2023/03/American-express.png" class="img-fluid d-block w-50" alt="Imagen 3">
                    <caption>img-7</caption>
                </div>
                <div class="carrusel-item">
                    <img src="http://localhost:8080/wordpress/wp-content/uploads/2023/03/mi-tienda-logo.png" class="img-fluid d-block w-50" alt="Imagen 4">
                    <caption>img-8</caption>
                </div>
            </div>
            <button class="carrusel-control text-black-50 prev">&lt;</button>
            <button class="carrusel-control text-black-50 next">&gt;</button>
        </div>        
    </div>
    ...
    <style>
        ...
        .carrusel-item {
            flex: 0 0 calc(100% / 4);
            transition: left 0.5s ease-in-out; /* Animación de deslizamiento */
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const itemsPerPage = 4; // Número de elementos que queremos mostrar por página
            let currentPage = 0;
            ...
            function showPage(page) {
                ...
                carruselItems.forEach((item, i) => {
                    if (i >= startIndex && i < endIndex) {
                        ...
                        item.classList.add("slide-in"); // Agregar clase de animación
                    } else {
                        item.style.display = "none";
                        item.classList.remove('d-flex');
                        item.classList.remove("slide-in"); // Quitar clase de animación
                    }
                });
            ...
            function nextPage() {
                const nextPageIndex = (currentPage + 1) % Math.ceil(carruselItems.length / itemsPerPage);
                showPage(nextPageIndex);
            }

            function prevPage() {
                const prevPageIndex = (currentPage - 1 + Math.ceil(carruselItems.length / itemsPerPage)) % Math.ceil(carruselItems.length / itemsPerPage);
                showPage(prevPageIndex);
            }

            function startAutoPlay() {
                intervalId = setInterval(nextPage, 3000); // Cambia la imagen cada 3 segundos (3000 ms)
            }

            function stopAutoPlay() {
                clearInterval(intervalId); // Detiene la reproducción automática
            }
            ...
            startAutoPlay(); // Comienza la reproducción automática al cargar la página
    ...
    <!-- Pruebas nuestras notas -->
    <script>
            document.addEventListener('DOMContentLoaded', ()=> {
            const idiomaSeleccionado = localStorage.getItem("idioma");
            const contenidoNotaBlog = document.querySelector('.con-no-bl');
            const notaEn = document.querySelector('.not-en');
            notaEn.classList.add('d-none');
            const notaEs = document.querySelector('.not-es');
            const contenidoNota = document.querySelector('.cont-not-en');



            if(idiomaSeleccionado === 'en-US' && contenidoNota.textContent.trim() === '') {
                notaEs.classList.add('d-none');
                // Seleccionar el contenido de la nota, respetando los enlaces y las imágenes
                function seleccionarTexto(contenedor) {
                    // Verificar si el contenido traducido ya está almacenado en el localStorage
                    const url = window.location.href;
                    const contenidoAlmacenado = localStorage.getItem(url);
                    if (contenidoAlmacenado) {
                        contenedor.innerHTML = contenidoAlmacenado;
                        return; // No es necesario hacer una solicitud fetch
                    }

                    let textoSeleccionado = contenedor.innerHTML; // Usar innerHTML en lugar de textContent

                    let objNotas = {};
                    objNotas.textNotas = textoSeleccionado;
                    ...
                    fetch('http://localhost:7000/notas-blog', {
                        method: 'POST',
                        headers: {
                    ...
                    .then((data) => {
                        let contenidoTraduccion = JSON.parse(data); 
                        let textoTraducido = contenidoTraduccion.contenido;

                        // Guardar el contenido traducido en el localStorage
                        localStorage.setItem(url, textoTraducido);

                        contenedor.innerHTML = textoTraducido; // Usar innerHTML en lugar de textContent

                        console.log(textoSeleccionado);
                        console.log(contenidoTraduccion.contenido);
                    })
                    .catch(error => {
                ...
                const compartirRRSS = document.querySelectorAll('.compartir-redes-sociales');
                ...
                let tituloNotaEn = document.querySelector('.tit-nota-es');
                tituloNotaEn.textContent = `<?php echo $titulo;?>`;

                // Contenido
                let contenedor = document.querySelector('.cont-nota-es.content-title');         

                // llamar a la función
                seleccionarTexto(contenedor); 
            } else if(idiomaSeleccionado === 'en-US' && contenidoNota) {
                    notaEn.classList.remove('d-none'); 
                    notaEs.classList.add('d-none');
            ...
            } else if(idiomaSeleccionado !=='en-US' && idiomaSeleccionado === 'es') {
                notaEn.classList.add('d-none');
            }
        })
    </script>
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        const idiomaSeleccionado = localStorage.getItem("idioma");
        const contenidoNotaBlog = document.querySelector('.con-no-bl');
        const notaEn = document.querySelector('.not-en'); // Contenido nota en Inglés
        const notaEs = document.querySelector('.not-es'); // Contenido nota en Español
        const contenidoNota = document.querySelector('.cont-not-en'); // Contenido nota

        notaEn.classList.add('d-none'); // Ocultar la nota en inglés por defecto
        if (idiomaSeleccionado === 'en-US' && contenidoNota.innerHTML.trim() === '') {
            ...
            // Función para seleccionar y traducir el contenido
            function seleccionarYTraducirContenido(contenedor) {
                // Verificar si el contenido traducido ya está almacenado en el localStorage
                const url = window.location.href;
                const contenidoAlmacenado = localStorage.getItem(url);
                if (contenidoAlmacenado) {
                    insertarContenidoTraducido(contenidoAlmacenado);
                    return; // No es necesario hacer una solicitud fetch
                }

                // Seleccionar el contenido a traducir
                const textoSeleccionado = contenedor.innerHTML;

                // Petición al servidor para traducir el contenido
                const titNotas = JSON.stringify({
                    objNotas: { textNotas: textoSeleccionado },
                    idiomaSelect: 'en-US'
                });

                fetch('http://localhost:4000/notas-blog', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
                ...
                .then((data) => {
                    const contenidoTraducido = JSON.parse(data).contenido;

                    // Guardar el contenido traducido en el localStorage
                    localStorage.setItem(url, contenidoTraducido);

                    insertarContenidoTraducido(contenidoTraducido);
                })
                .catch(error => {
                    console.error('Error:', error);
                });
            ...
            // Función para insertar el contenido traducido en el DOM
            function insertarContenidoTraducido(contenidoTraducido) {
                // Crear un elemento div temporal
                const divTemporal = document.createElement('div');
                divTemporal.innerHTML = contenidoTraducido;

                // Recorrer todos los nodos hijos del div temporal y agregarlos al cuerpo del documento
                divTemporal.childNodes.forEach((nodo) => {
                    document.body.appendChild(nodo.cloneNode(true)); // Clonar el nodo para evitar moverlo desde su posición original
                });
            }

            // Llamar a la función para seleccionar y traducir el contenido
            const contenidoSeleccionado = document.querySelector('.cont-nota-es');
            seleccionarYTraducirContenido(contenidoSeleccionado);

            console.log('La nota se tradujo correctamente'); 
...
<!-- ./ Nuestras notas pruebas -->
    ...
    <!-- Carrusel actividades de las empresas -->
    <div id="<?php echo $empresa_id . '-carrusel-actividades-empresas'; ?>" class="carousel carousel-fade" data-ride="carousel">
    <div class="carousel-inner">
    <!-- Contenido reforestación -->
    <?php if(!empty($empresa['texto_reforestacion']) && !empty($empresa['imagenes_reforestacion'])){?>
    <div class="carousel-item active">
        <div class="row">
            <h3><?php echo $empresa['titulo_reforestacion']; ?></h3>
        </div>
        <div class="row align-items-center acciones_empresas">
            ...
            <div class="col-12 col-lg-6">
                ...
                <div id="<?php echo $empresa_id . '-carrusel-reforestacion'; ?>" class="carousel slide" data-ride="carousel">
                        ...
                        <?php foreach(array_reverse($empresa['imagenes_reforestacion']) as $index => $imagen) { ?>
                            <div class="carousel-item  <?php echo $index === 0 ? 'active' : ''; ?>">
                                <div class="d-flex justify-content-center">
                                    <img src="<?php echo $imagen; ?>" class="img-fluid" alt="Imagen <?php echo $index + 1; ?>" style="width:320px!important; height:302px!important;"> 
                                </div>
                                
                            </div>
                        <?php } ?>
                    </div>
                    <button class="carousel-control-prev" type="button" data-bs-target="#<?php echo $empresa_id . '-carrusel-reforestacion'; ?>" data-bs-slide="prev">
                        <span class="btn btn-light" aria-hidden="true">
                    ...
                    <button class="carousel-control-next" type="button" data-bs-target="#<?php echo $empresa_id . '-carrusel-reforestacion'; ?>" data-bs-slide="next">
                        <span class="btn btn-light" aria-hidden="true">
    ...
    <div  class="carousel-item">
        <div class="row">
            <h3><?php echo $empresa['titulo_matenimiento']; ?></h3>
        </div>
        <div class="row align-items-center acciones_empresas">
            <div class="col-12 col-lg-6">
            ...
            <div class="col-12 col-lg-6">
                ...
                <div id="<?php echo $empresa_id . '-carrusel-mantenimiento'; ?>" class="carousel slide" data-ride="carousel">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#<?php echo $empresa_id . '-carrusel-mantenimiento'; ?>" data-bs-slide="prev">
                        <span class="btn btn-light" aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8"/>
                            </svg>
                    ...
                    <button class="carousel-control-next" type="button" data-bs-target="#<?php echo $empresa_id . '-carrusel-mantenimiento'; ?>" data-bs-slide="next">
                        <span class="btn btn-light" aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
                            </svg>
    ...
    <!-- Contenido brechas cortafuego -->
    <?php if(!empty($empresa['texto_brechas']) && !empty($empresa['imagenes_brechas'])){?>
    <div class="carousel-item">
        <div class="row">
            <h3><?php echo $empresa['titulo_brechas']; ?></h3>
        </div>
        <div class="row align-items-center acciones_empresas">
            <div class="col-12 col-lg-6">
            ...
            <div class="col-12 col-lg-6">
                ...
                <div id="<?php echo $empresa_id . '-carrusel-brechas'; ?>" class="carousel slide" data-ride="carousel">
                    ...
                    <button class="carousel-control-prev" type="button" data-bs-target="#<?php echo $empresa_id . '-carrusel-brechas'; ?>" data-bs-slide="prev">
                        <span class="btn btn-light" aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8"/>
                            </svg>
                    ...
                    <button class="carousel-control-next" type="button" data-bs-target="#<?php echo $empresa_id . '-carrusel-brechas'; ?>" data-bs-slide="next">
                        <span class="btn btn-light" aria-hidden="true">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
                            </svg>
    ...
    <button class="carousel-control-prev" type="button" data-bs-target="#<?php echo $empresa_id . '-carrusel-actividades-empresas'; ?>" data-bs-slide="prev">
    <span class="btn btn-light" aria-hidden="true">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8"/>
        </svg>
    ...
    <button class="carousel-control-next" type="button" data-bs-target="#<?php echo $empresa_id . '-carrusel-actividades-empresas'; ?>" data-bs-slide="next">
    <span class="btn btn-light" aria-hidden="true">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
            <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
        </svg>
    ...
    <!-- Modal actividades empresas -->
    <!-- Contenido acciones empresas -->
    <div class="container">               
        <div class="row row-cols-2 justify-content-center">
            <div class="col content-card-aliados" id="<?php echo $empresa_id . '-modal'; ?>">
                <div class="card border-0 shadow" id="contenidoPopup">
                    <div class="card-body">
                        <div class="container">
                            <!-- Nombre empresa -->
                            <div class="row">
                                <div class="col-12 py-3">
                                    <h3 class="text-light text-center"><?php echo $tituloEmpresa = $empresa['nombre_empresa']; ?></h3>
                                </div>
                            </div>

                            <!-- <h2 class="text-center text-light">Acciones</h2> -->
                            ...
                            <div class="row row-cols-1 row-cols-md-3 justify-content-center align-items-center my-3">
                                ...
                                <?php  if(!empty($empresa['titulo_reforestacion'])) { ?>
                                    <div class="col w-auto"> 
                                        <p class="btn btn-outline-light btn-actividad <?php echo sanitize_title($empresa['titulo_reforestacion']) . '-empresa';?>"  data-target="<?php echo $empresa_id . '-btn-reforestacion';?>">
                                ...
                                <?php if(!empty($empresa['titulo_mantenimiento'])) { ?>
                                    <div class="col w-auto">
                                        <p class="btn btn-outline-warning btn-actividad <?php echo sanitize_title($empresa['titulo_mantenimiento']) . '-empresa';?>"  data-target="<?php echo $empresa_id . '-btn-mantenimiento';?>">
                                ...
                                <?php  if(!empty($empresa['titulo_brechas'])) { ?>
                                    <div class="col w-auto">
                                        <p class="btn btn-outline-danger btn-actividad brechas-cortafuego-empresa"  data-target="<?php echo $empresa_id . '-btn-brechas';?>">
                                ...
                                <?php  if(!empty($empresa['titulo_otras_asctividades'])) { ?>
                                    <div class="col w-auto">
                                        <p class="btn btn-outline-success btn-actividad actividades-uno-empresa"  data-target="<?php echo $empresa_id . '-btn-actividades-uno';?>">
                                ...
                                <?php  if(!empty($empresa['titulo_otras_asctividades_dos'])) { ?>
                                    <div class="col w-auto">
                                        <p class="btn btn-outline-info btn-actividad actividades-dos-empresa"  data-target="<?php echo $empresa_id . '-btn-actividades-dos';?>">
                            ...
                            <div class="row act-emp">
                                            ...
                                            <div id="<?php echo $empresa_id . '-carrusel-reforestacion'; ?>" class="carousel slide" data-ride="carousel">
                                                <div class="carousel-inner">
                                                    <?php foreach(array_reverse($empresa['imagenes_reforestacion']) as $index => $imagen) { ?>
                                                        <div class="carousel-item  <?php echo $index === 0 ? 'active' : ''; ?>">
                                                            <div class="d-flex justify-content-center">
                                                                <img src="<?php echo $imagen; ?>" class="img-fluid" alt="Imagen <?php echo $index + 1; ?>" style="width:320px!important;"> 
                                                            </div>
                                ...
                                <!-- Contenido mantenimiento warning -->
                                <?php if(!empty($empresa['texto_matenimiento']) && !empty($empresa['imagenes_mantenimiento'])){?>
                                ...
                                <!-- Contenido brechas cortafuego danger -->
                                <?php if(!empty($empresa['texto_brechas']) && !empty($empresa['imagenes_brechas'])){?>
                                ...
                                <!-- Contenido otras actividades 1 success -->
                                    ...
                                    <div class="row align-items-center acciones_empresas">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <div id="<?php echo $empresa_id . '-carrusel-actividades-uno'; ?>" class="carousel slide" data-ride="carousel">
                                                ...
                                                <button class="carousel-control-prev" type="button" data-bs-target="#<?php echo $empresa_id . '-carrusel-actividades-uno'; ?>" data-bs-slide="prev">
                                                    <span class="btn btn-success" aria-hidden="true">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                                                            <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8"/>
                                                        </svg>
                                                    </span>
                                                ...
                                                <button class="carousel-control-next" type="button" data-bs-target="#<?php echo $empresa_id . '-carrusel-actividades-uno'; ?>" data-bs-slide="next">
                                                    <span class="btn btn-success" aria-hidden="true">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                                            <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
                                                        </svg>
                                ...
                                <!-- Contenido otras actividades 2 info -->
                                    ...
                                    <div class="row align-items-center acciones_empresas">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            ...
                                            <div id="<?php echo $empresa_id . '-carrusel-actividades-dos'; ?>" class="carousel slide" data-ride="carousel">
                                                ...
                                                <button class="carousel-control-prev" type="button" data-bs-target="#<?php echo $empresa_id . '-carrusel-actividades-dos'; ?>" data-bs-slide="prev">
                                                    <span class="btn btn-info" aria-hidden="true">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left" viewBox="0 0 16 16">
                                                            <path fill-rule="evenodd" d="M15 8a.5.5 0 0 0-.5-.5H2.707l3.147-3.146a.5.5 0 1 0-.708-.708l-4 4a.5.5 0 0 0 0 .708l4 4a.5.5 0 0 0 .708-.708L2.707 8.5H14.5A.5.5 0 0 0 15 8"/>
                                                        </svg>
                                                    </span>
                                                ...
                                                <button class="carousel-control-next" type="button" data-bs-target="#<?php echo $empresa_id . '-carrusel-actividades-dos'; ?>" data-bs-slide="next">
                                                    <span class="btn btn-info" aria-hidden="true">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                                            <path fill-rule="evenodd" d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8"/>
                                                        </svg>
                    ...
                    <div class="card-footer border-0 d-flex justify-content-center">
                        <a class="btn btn-outline-light" id="cerrarPopup">Salir</a>
                    </div>
                </div>
            </div>
        </div>
    </div>    
    <!-- Fin del acciones empresas -->    
    <!-- ./Modal actividades empresas -->




    <!-- Pop-up empresas (final - final - final) -->
        ...
        document.addEventListener("DOMContentLoaded", ()=> {
            ...
            <style>   
                ...
                .image-modal-content {
                    ...
                    /*max-height: 100vh;  Establece una altura máxima para el contenido */
                }
                .content-img {
                    max-width: 100px;
                    max-height: 100px;
                ...
                .image-modal {
                    height: 500px;
                    max-width: 700px; /* Ajusta el tamaño máximo de la imagen */
                }
                ...
                /* Animación para abrir y cerrar el modal */
                ...
                .fade-out {
                    animation: modalFadeOut 0.8s forwards;
            ...
            // Contenido primer modal 
            const galeryFristModal = function() {
                const imageFristModal = document.querySelectorAll('.image-first-modal');

                imageFristModal.forEach(img => {
                    ...
                    img.addEventListener('click', () => {
                        ...
                        // Second modal
                        const secondModal = document.getElementById(img_id + '-Modal'); 
                        secondModal.classList.remove("d-none");
                        secondModal.classList.add('selected');

                        // Principal image in second modal
                        const imageModal = document.getElementById(img_id + '-Image');
                        imageModal.src = img.src;  

                        // Clase de la imagen modal
                        const imgModal = document.querySelectorAll('#' + img_id + '-Items');
                        const secondImageModal = document.querySelectorAll('.image-modal');
                        // id="-Galery-Image"
                        let currentIndex = 0;

                        let autoChangeInterval; // Variable para almacenar el intervalo del cambio automático
                        let autoChangeActive = true; // Variable para controlar el estado del cambio automático


                        // Función para mostrar la siguiente imagen en el segundo modal
                        function showNextImage() {
                            currentIndex = (currentIndex) % imgModal.length; // Circular: vuelve al principio si se llega al final
                            console.log( imgModal.length);
                            const nextImg = imgModal[currentIndex];

                            // Remover la clase 'active' de todas las imágenes
                            imgModal.forEach(img => {
                                img.classList.remove('opacity-50');
                            });
                            // Aplicar la clase 'active' a la imagen seleccionada
                            nextImg.classList.add('opacity-50');
                            // Mostrar la imagen seleccionada en el modal IMG MODAL
                            secondImageModal.forEach(secImg => {
                                secImg.src = nextImg.src;
                                secImg.classList.toggle('selected');
                            });
                        };
                    
                        // 
                        imgModal.forEach((img, index) => {
                            img.addEventListener('click', () => {
                                    currentIndex = index;
                                // console.log(currentIndex); 
                                showNextImage(); // Mostrar la imagen seleccionada
                            });

                            img.addEventListener('mouseover', () => {
                                // Agregar opacidad al pasar el ratón sobre la imagen
                                img.style.opacity = '0.7';
                            });

                            img.addEventListener('mouseout', () => {
                                // Restablecer opacidad al quitar el ratón de la imagen
                                img.style.opacity = '1';
                            });
                            ...
                            const btnNext = document.querySelectorAll('#nextSecondButton'); 
                            const btnPreview =  document.querySelectorAll('#prevSecondButton');

                            btnNext.forEach(btn => {
                                btn.addEventListener('click', function() {
                                    if (currentIndex < imgModal.length - 1) {
                                        currentIndex++;
                                        modalImg.src = imgModal[currentIndex].src;

                                        if(modalImg.src == imgModal[currentIndex].src) {
                                            imgModal[currentIndex].classList.add('opacity-50')
                                        }

                                        // Recorre todas las imágenes y quita la clase 'opacity-50' de aquellas que no coinciden con el índice actual
                                        imgModal.forEach((img, index) => {
                        ...
                        const showImage = (index) => {
                            const img = imgModal[index];
                            secondImageModal.src = img.src;
                        };
                        ...
                        // close button 
                        const closeBtn = document.querySelectorAll('.btn-cerrar');

                        closeBtn.forEach(btnClose => {
                                btnClose.addEventListener('click', ()=> {
                                    secondModal.classList.add('d-none');                                    
                            })
                        })
            ...
            // Contenido Segundo modal 
            const galerySecondModal = function() {
                // Clase de la imagen modal
                const imgModal = document.querySelectorAll('.img-modal-gal');
                const secondImageModal = document.querySelector('.image-modal');
                let currentIndex = 0;

                // Función para mostrar la siguiente imagen
                const showNextImage = () => {
                    currentIndex = (currentIndex + 1) % imgModal.length; // Circular: vuelve al principio si se llega al final
                    const nextImg = imgModal[currentIndex];
                    // Id imagen
                    console.log(nextImg.id);
                    // Remover la clase 'active' de todas las imágenes
                    imgModal.forEach(img => img.classList.remove('opacity-50'));
                    // Aplicar la clase 'active' a la imagen seleccionada
                    nextImg.classList.add('opacity-50');
                    // Mostrar la imagen seleccionada en el modal IMG MODAL
                    secondImageModal.src = nextImg.src;
                    console.log(nextImg.src);
                };

                // Función para iniciar el cambio automático de imágenes
                const startAutoChange = () => {
                    setInterval(showNextImage, 5000); // Cambiar imagen cada 5 segundos (5000 milisegundos)
                };

                // Evento click para cambiar manualmente la imagen
                imgModal.forEach((img, index) => {
                    img.addEventListener('click', () => {
                        currentIndex = index;
                        showNextImage(); // Mostrar la imagen seleccionada
                    ...
                    // Resto del código de los eventos mouseover y mouseout...
                });

                // Iniciar el cambio automático de imágenes cuando se carga la página
                startAutoChange();
            };
    ...
    <script>
        document.addEventListener('DOMContentLoaded', ()=> {
            ...
            styleContent.textContent = `
                    .image-second-carrusel img{
                        max-width: 900px;
                        height: 600px;
                    }

                    .container-gallery-general {
                        max-width: 500px;
                        flex: 0 0 auto;
                        display: flex;
                        justify-content: center;
                    ...
                    .container-gallery-general img {
                        max-width: 200px;
                        height: 80px;
                        margin: 5px;
                    }
                    .container-gallery-general::-webkit-scrollbar-track {
                        color: beige;
                    }
            ...
            // Contentdor galería imágenes pequeñas
            const containerGalleryItems = document.querySelectorAll('.container-gallery-general');  
            // Scroll vertical en las imagenes en miniatura
            containerGalleryItems.forEach(imgs => {
                imgs.addEventListener('wheel', event => {
                    event.preventDefault();

                    // Calcular la cantidad del scroll 
                    const scrollAmount = event.deltaY * 2; 

                    // Aplicar el desplazamiento horizontal a la sección
                    imgs.scrollLeft += scrollAmount; 
            ...
            const imgContainerModal = document.querySelectorAll('.container-gallery-general img'); 

            imgContainerModal.forEach(img=> {
                ...
                img.addEventListener('click', (e)=> {
                    ...
                    imgContainerModal.forEach(otherImg => {
                        if (otherImg !== img) {
                            otherImg.classList.remove('opacity-50');
                        }
                    });
                })
            ...
            // carrusel item
            const carruselImage = document.querySelectorAll('.carrusel-modal div img');

            carruselImage.forEach(img=> {
...
<div class="container">
    <h1 class="text-center text-light">Mapa de las ciudades reconocidas del programa TCW</h1>
        <button class="btn btn-light text-white" id="button-states">Guardar elementos</button>
    <div class="row row-cols-1 row-cols-md-2 justify-content-center">
        <div class="col">
            <figure style="min-height:6rem" class="position-relative recognozide-cities-content">
                <svg aria-hidden="true" tabindex="-1" class="d-none d-lg-block" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1" id="svg3919" viewBox="199.866 127.471 600 425" enable-background="new 199.866 127.471 600 425" xml:space="preserve">
                    <g id="map_recognized_cities">
                        <g>
                            ...
                            <path data-id="0007" data-estado="Chiapas" d="M687.26,547.681c-2.815-2.635-5.821-5.483-6.681-6.33c-1.545-1.521-1.547-1.536-0.156-1.206
                                    ...
                                    c0.007,1.581-0.993,3.189-1.983,3.189C692.642,552.471,690.074,550.314,687.26,547.681z" class="">
                                <title>Chiapas</title>
                            </path>
                            ...
                            <path data-id="0020" data-estado="Oaxaca" d="M596.648,529.889c-0.553-0.31-2.423-0.83-4.155-1.16c-1.732-0.328-4.304-1.359-5.714-2.293
                                    ...
                                    c-0.84,0.551-2.655,1.256-4.034,1.565c-1.378,0.31-3.846,1.383-5.481,2.386c-1.638,1.002-3.961,1.979-5.164,2.174
                                                                C598.839,530.375,597.61,530.427,596.648,529.889z" class="">
                                <title>Oaxaca</title>
                            </path>
                            ...
                            <path data-id="0012" data-estado="Guerrero" d="M553.292,515.931c-0.204-0.529-0.64-0.963-0.969-0.963s-1.271-0.799-2.093-1.776
                                    ...
                                    C553.938,516.69,553.607,516.754,553.292,515.931z" class="">
                            ...
                            <path data-id="0016" data-estado="Michoacán de Ocampo" d="M471.791,480.276c-1.203-0.463-3.007-0.863-4.009-0.89c-1.001-0.026-3.111-0.862-4.688-1.857
                                    ...
                                    C474.752,481.141,472.994,480.74,471.791,480.276z" class="">
                            ...
                            <path data-id="0015" data-estado="México" d="M517.216,469.547c-0.229-0.229-0.416-0.993-0.416-1.698c0-0.704-0.447-2.448-0.991-3.875
                                    ...
                                    c-0.699,1.688-1.068,1.889-3.478,1.889c-2.28,0-2.899,0.288-4.029,1.874C519.26,469.899,518.084,470.414,517.216,469.547z" class="">
                                <title>México</title>
                            </path>
                            ...
                            <path data-id="0014" data-estado="Jalisco" d="M448.037,456.873c0-0.613,0.27-2.538,0.6-4.279c0.47-2.475,0.399-3.569-0.324-5.018
                            ...
                            <path data-id="0009" data-estado="Ciudad de México" d="M541.216,454.985c-1.769-0.275-2.239-0.682-2.654-2.291c-0.441-1.708-0.231-2.252,1.662-4.32
                                    ...
                                    C545.52,455.139,544.837,455.55,541.216,454.985z" class="">
                            ...
                            <path data-id="0013" data-estado="Hidalgo" d="M553.298,441.367c-1.188-3.775-1.342-3.907-4.604-3.907c-2.941,0-3.139-0.099-3.139-1.581
                                    ...
                                    c0,1.377-0.464,2.121-1.816,2.92C556.362,442.794,553.743,442.783,553.298,441.367z" class="">
                                <title>Hidalgo</title>
                            </path>
                            ...
                            <path data-id="0011" data-estado="Guanajuato" d="M504.454,432.997c-0.24-0.921-0.905-1.126-3.509-1.086c-1.767,0.027-3.813,0.43-4.55,0.894
                                    ...
                                    c-0.813,0-2.157,0.534-2.986,1.187C512.077,434.698,504.896,434.68,504.454,432.997z" class="">
                            ...
                            <path data-id="0022" data-estado="Querétaro" d="M520.681,432.342c-0.416-0.416-0.76-1.052-0.764-1.413c-0.004-0.36-1.528-1.989-3.388-3.619
                                    ...
                                    C521.644,432.755,521.271,432.933,520.681,432.342z" class="">
                            ...
                            <path data-id="0032" data-estado="Zacatecas" d="M444.755,407.606c-0.602-0.132-1.094-0.481-1.094-0.777s-0.6-0.728-1.333-0.959
                                    ...
                                    c-1.203-0.07-2.891,0.101-3.75,0.381C446.552,407.616,445.356,407.738,444.755,407.606z" class="">
                                <title>Zacatecas</title>
                            </path>

                            <path data-id="0024" data-estado="San Luis Potosí" d="M545.903,404.626c-0.667-0.505-1.737-0.918-2.379-0.918c-0.805,0-1.65-1.061-2.733-3.426
                                    ...
                                    c-1.055,0.336-1.219,0.745-0.893,2.232c0.395,1.795,0.36,1.821-2.307,1.801C548.335,405.553,546.571,405.131,545.903,404.626z" class="">
                            ...
                            <path data-id="0010" data-estado="Durango" d="M429.197,377.452c-0.563-0.333-1.219-1.38-1.456-2.326s-0.761-1.93-1.164-2.186
                                    ...
                                    c-1.539,1.263-2.471,6.316-2.79,15.11c-0.167,4.602-0.539,7.519-1.009,7.896C433.515,377.678,430.306,378.109,429.197,377.452z" class="">
                                <title>Durango</title>
                            </path>

                            <path data-id="0019" data-estado="Nuevo León" d="M512.365,361.673c-0.032-0.43-0.01-3.404,0.052-6.608c0.103-5.38-0.02-6.025-1.574-8.375
                            ...
                            <path data-id="0005" data-estado="Coahuila de Zaragoza" d="M504.124,331.627c-0.319-0.814-0.817-1.019-1.752-0.722c-1.573,0.499-3.849-1.415-5.008-4.215
                                ...
                                c-0.388,0.469-0.57,1.373-0.402,2.011c0.166,0.637,0.12,2.256-0.103,3.597C504.67,332.165,504.461,332.484,504.124,331.627z" class="">
                            ...
                            <path data-id="0008" data-estado="Chihuahua" d="M383.181,301.367c-2.004-0.181-2.657-0.504-2.657-1.315c0-0.592-0.96-2.065-2.134-3.273
                                    ...
                                    c-0.005,1.58-0.216,3.159-0.469,3.51c-0.521,0.724-3.729,2.231-4.396,2.065C386.036,301.655,384.643,301.499,383.181,301.367z" class="">
                            ...
                            <path data-id="0003" data-estado="Baja California Sur" d="M316.143,360.272c-0.948-1.01-1.621-2.715-1.913-4.845c-0.248-1.808-1.255-4.945-2.241-6.973
                                ...
                                C282.663,259.946,282.381,259.507,282.381,258.971z" class="">
                            ...
                            <path data-id="0002" data-estado="Baja California" d="M270.504,225.88c-0.998-1.201,0.02-1.214,1.6-0.02c1.02,0.771,1.05,0.921,0.196,0.938
                                ...
                                C268.687,218.01,267.467,217.682,264.864,214.875z" class="">
                            ...
                            <path data-id="0026" data-estado="Sonora" d="M276.509,225.308c0.209-0.544,0.654-0.99,0.99-0.99c0.822,0,0.307,1.42-0.627,1.731
                                    ...
                                    C246.233,159.114,245.181,158.92,244.35,157.095z" class="">
                                <title>Sonora</title>
                            </path>
...
<?php foreach($nuestrosProgramas as $programa) {
   ...
   <!-- Progrmas -->
   <div class="container container_programa-tcw mt-5">
       <div class="row justify-content-between align-items-center shadow content-tcw">
           <div class="col-lg px-0">
               <div class="row">
                   <div class="col d-flex justify-content-center">
                       <img src="<?php echo $logoPrograma; ?>" class="img-fluid" width="350" alt="">
                   </div>
               </div>
           ...
           <div class="col-lg my-3">
               <div class="container">
                   <div class="row d-grid align-items-center px-3">
                       <div class="col-12 texto-contenido-ac text-tcw">
                           <?php echo $resumenPrograma; ?>
                       </div>
                   </div>
               </div>
           </div>
       ...
       <!-- Resultados -->
       <div class="container container_resultados_tcw">
           <h2 class="text-primary fw-semibold text-center h1 my-4"><?php echo $tituloResultado; ?></h2>

           <div class="row justify-content-center content_resultados_tcw">

               
                <?php 
                if(!empty($resultadoUno) && !empty($textoResultadoUno)) { ?>
                   <!-- Resultado Uno -->
                   <div class="col-md iconos_resultados_tcw">
                       <div class="card icono-resultado-tcw bg-transparent border-0 shadow rounded-4">
                           <div class="card-header bg-transparent border-0 ">
                               <h3 class="text-center fw-semibold text-primary subtitulos-contenido-tcw"> <?php echo $condicionNumeraliaDocArbol; ?> <span class="counter" data-target="<?php echo $resultadoUno; ?>"><?php echo $resultadoUno; ?></span> </h3>
                           </div>
               ...
               if(!empty($resultadoDos) && !empty($textoResultadoDos)) { ?>
                   ...
                   <div class="col-md iconos_resultados_tcw">
                       <div class="card icono-resultado-tcw bg-transparent border-0 shadow rounded-4">
                           <div class="card-header bg-transparent border-0 ">
                               <h3 class="text-center fw-semibold text-primary subtitulos-contenido-tcw"> <?php echo $condicionNumeraliaDocArbol; ?> <span class="counter" data-target="<?php echo $resultadoDos; ?>"><?php echo $resultadoDos; ?></span> </h3>
                           </div>
                   ...
                   <div class="col-md iconos_resultados_tcw">
                       <div class="card icono-resultado-tcw bg-transparent border-0 shadow rounded-4">
                           <div class="card-header bg-transparent border-0 ">
                               ...
                               <h3 class="text-center fw-semibold text-primary subtitulos-contenido-tcw"> <?php echo $condicionNumeraliaDocArbol; ?> <span class="counter" data-target="<?php echo $resultadoTres; ?>"><?php echo $resultadoTres; ?></span> </h3>
                           </div>
               ...
               if(!empty($resultadoTres) && !empty($textoResultadoTres)) { ?>
                   ...
                   <div class="col-md iconos_resultados_tcw">
                       <div class="card icono-resultado-tcw bg-transparent border-0 shadow rounded-4">
                           <div class="card-header bg-transparent border-0 ">
                               <h3 class="text-center fw-semibold text-primary subtitulos-contenido-tcw"> <?php echo $condicionNumeraliaDocArbol; ?> <span class="counter" data-target="<?php echo $resultadoCuatro; ?>"><?php echo $resultadoCuatro; ?></span> </h3>
                           </div>
           ...
           <?php  if(!empty($documentoConocePrograma)) { ?>
               <div class="container content_saber-mas-tcw">
                       ...
                       <div class="modal-dialog modal-xl">
                           <div class="modal-content">
                               <div class="modal-header">
                                   <h5 class="modal-title" id="pdfModalLabel">Tree Cities of the World</h5>
...
<!-- Agregar las ciudades reconocidas en el año 2024 en un mapa svg (leaflet no conviene mucho por el alcance de la información) -->
<div class="container">
    <h1 class="text-center text-light">Mapa de las ciudades reconocidas del programa TCW</h1>
    <div class="row row-cols-1 row-cols-md-2 justify-content-center">
        <div class="col">
...
<!-- Red Oja memorias  -->
<?php
// Agrupar documentos por seccion_documento y año
$agrupados = [];

foreach ($memorias as $memoria) {
    $anio = date('Y', strtotime($memoria['fecha_memoria'])); // Extraer solo el año
    $seccion = $memoria['seccion_documento'];

    // Almacenar en el array agrupado
    $agrupados[$seccion][$anio][] = $memoria;
}

// Definir opciones de secciones
$options = [
    'Memorias' => 'Memorias',
    'documento_dos' => 'Documento Dos',
    'documento_tres' => 'Documento Tres',
    'documento_cuatro' => 'Documento Cuatro'
];
?>

    <div class="container content-results my-0">
        <?php foreach ($agrupados as $seccion => $anios) : ?>
            <?php foreach ($anios as $anio => $documentos) : ?>
                <div class="row justify-content-center">
                    <div class="col py-3">
                        <!-- Mostrar solo un título de sección por año -->
                        <div class="d-flex align-items-center flex-shrink-0 p-3 link-body-emphasis text-decoration-none border-bottom border-top">
                            ...
                            <h4 class="subtitulo-red-oja fw-semibold">
                                <?php echo isset($options[$seccion]) ? $options[$seccion] : 'Opción no válida'; ?> - <?php echo $anio; ?>
                            </h4>
                        </div>

                        <!-- Listar los documentos correspondientes -->
                        <div class="list-group list-group-flush scrollarea">
                            <?php foreach ($documentos as $memoria) : ?>
                                <a href="#" class="list-group-item list-group-item-action border-0 py-3 lh-sm" aria-current="true">
                                    <div class="d-flex w-100 align-items-center justify-content-between">
                                        <strong class="mb-1">
                                            <span class="mx-1"><i class="bi bi-file-earmark-post"></i></span>
                                            <?php echo $memoria['titulo_pop_up']; ?>
                                        </strong>
                                    </div>
                                </a>
                            <?php endforeach; ?>
    ...
    <div class="content_all_infographics" id="infogrphics_container">

        <div class="all_infographics">
                <h3 class="text-secondary text-center title_results" id="title_results">Resultados</h3>

                    <?php if($infografias) {
                        foreach($infografias as $index => $infografia) { 
                        ?>

                        <?php $infografia_id = sanitize_title($infografia['nombre_especie'] . $index); ?>
                        <?php $condicionModal = (!empty($infografia['nombre_especie'])) ? $infografia_id . 'Modal' : ' '; ?>
                        <?php $categoria_infografia = $infografia['categoria']; ?>

                        <h3 class="text-secondary text-center"> <?php echo $categorias[$categoria_infografia]; ?> </h3>

                        <div class="row row-cols-md-auto row_infographics">
                            
                            <div class="col-auto col_infographics">
                                <div class="card card_infographics border-0 shadow rounded">
                                    ...
                                    <div class="card-footer d-flex justify-content-center border-0 bg-transparent">
                                        <button class="btn btn-secondary text-white" data-bs-toggle="modal" data-bs-target="#<?php echo $condicionModal;?>" id="<?php echo $infografia_id;?>">Ver infografía</button>
                                    </div>
                                </div>

                                <!-- Modal imagen inbfografía -->
